...
#include "../OthelloOnline/boardscene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BoardScene_t, stringdata) + ofs \
...
const QMetaObject BoardScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_BoardScene.data,
      qt_meta_data_BoardScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BoardScene.stringdata))
